        ...
        <div className="flex gap-3">
          ...
          {weeks.map((week, index) => (
            <button
              ...
              className={`flex-shrink-0 px-6 py-3 rounded-xl text-sm font-semibold transition-all focus:ring-2 focus:ring-offset-2 focus:ring-[#21BAEA] ${selectedIndex === index
